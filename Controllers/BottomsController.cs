...
namespace Wardrobe2.Controllers
{
    public class BottomsController : Controller
    {
        ...
        {
            var bottoms = db.Bottoms.Include(b => b.ClothingProperty);
        ...
        {
            ViewBag.BottomsID = new SelectList(db.ClothingProperties, "ClothingID", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Bottoms")] Bottom bottom)
        {
            ...
            ViewBag.BottomsID = new SelectList(db.ClothingProperties, "ClothingID", "Name", bottom.BottomsID);
            return View(bottom);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Bottoms")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
